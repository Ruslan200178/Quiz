...
<html>
	<head>
        ...
        <?php 
        session_start(); //the beginning of the script before any output is sent to the browser.
        if(isset($_SESSION['login_id'])){
            header('Location:home.php');
        }
        ?>
		<title>Admin | AutoQuiz</title>
	</head>

	<body id='login-body' class="bg-light">
         
        <div class="card col-md-6 offset-md-3 text-center bg-primary mb-4">
            <h3 class="he3-responsive text-white">AutoQuiz</h3>
        </div>
